// Adaption of SimpleHTTPExample for Wio Terminal by RoSchmi, using SSLClient and EthernetENC library
// which seemed to be more reliabel as UipEthernet
...
// This example downloads the URL "http://arduino.cc/" or "www.google.com"
...
//const char kPath[] = "/asciilogo.txt";  // for arduino.cc
...
// Use nonsecure transmission
//EthernetHttpClient  httpClient(client, kHostname, 80);

// Use TLS secured transmission
EthernetHttpClient  httpClient(sslClient, kHostname, 443);
...
void setup()
{
  ...
  Serial.print(F("DNS-Server IP address: "));
